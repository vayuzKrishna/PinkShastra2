...
public class TimeRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable(){
            ...
            public void run() {
                ...
                Intent mainIntent = new Intent(TimeRequest.this,Nav.class);
                TimeRequest.this.startActivity(mainIntent);
                TimeRequest.this.finish();
            }
